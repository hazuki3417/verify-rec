    ...
    return (
      <FormProvider {...methods}>
        ...
        >
          ...
          <InputPassword {...methods.register("value")} />
    ...
    return (
      <div>
        ...
        >
          <div>true</div>
          <div>
            <InputPassword {...args} disabled={true} />
          </div>
        </div>
        <div
          style={{
        ...
        >
          <div>false</div>
          <div>
            <InputPassword {...args} disabled={false} />
          </div>
        </div>
      </div>
    );
        ...
        {Object.entries(inputVariantStyleMap).map(([prop]) => {
          ...
          return (
            ...
            >
              <div>{prop}</div>
              <div>
                <InputPassword {...args} variant={value} />
              </div>
            </div>
          );
        })}
    ...
    return (
      <div>
        ...
        >
          <div>false</div>
          <div>
            <InputPassword {...args} error={false} />
          </div>
        </div>
      </div>
    );
